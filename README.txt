This is all written in Python 3, and you should be able to run the code without installing any outside libraries (I think!). The most interesting stuff will be in sim.py, which is a module that contains the logic to simulate baseball games. The file params.py has various parameters, some of which relate to code not in this excerpt (stuff like # of innings in a baseball game, number of outs in a half inning, etc.). The file misc.py contains miscellaneous helper functions. dirs.py contains information about directories, many of which I have not included. The rest of the files are class declarations.
